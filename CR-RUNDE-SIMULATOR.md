...
| T-41 | Wort bearbeiten · Lernstand | Der Lernstand steht **noch im alten Design** und folgt den Entwürfen nicht. **Mindestens** muss klar sein, dass es **kein editierbarer Bereich** ist — im Gegensatz zum Block darüber. |
| T-41 · umgesetzt | Die beiden Rollen sind jetzt getrennt, nach der Farbregel, die in dieser App ohnehin gilt: **Anzeige steht hell und ohne Linie, Eingabe bekommt Karte und Rahmen.** Der Lernstand hat **keinen Kasten** mehr, nur Haarlinien, gedämpfte Namen — und die Überschrift sagt es zusätzlich: *„Lernstand — nur zur Ansicht"*. Umgekehrt sah man den Feldern darüber nicht an, dass man hineinschreiben kann: jedes trägt jetzt eine **Linie, auf die man schreibt**, die beim Tippen rostrot wird. |
| T-38 · umgesetzt | Das Startbild von ChatGPT ist eingebaut: **rund 2,6 Sekunden**, dann blendet es in einer halben Sekunde weg. Ein Tipp bringt es sofort zum Verschwinden. Es folgt **keinem Farbschema** — es ist eine gezeichnete Illustration mit eigenen Farben, kein Bedienelement. Der Grund ist auf das Papier des Bildes gesetzt (`#ede3d8`), damit die schmalen Streifen oben und unten nahtlos anschliessen. Datei von 3,1 MB auf **547 KB** verkleinert (788 × 1400, JPEG). Es kommt einmal je App-Start, nicht bei jedem Neuzeichnen. |
| T-42 | Einstellungen · Rechtstexte | **Datenschutz und Impressum aus den Einstellungen nehmen** und in einen eigenen, anklickbaren Bildschirm („Über diese App" oder übliche Bezeichnung) legen: ein langer Rollbildschirm, der **mit dem Startbild anfängt**. |
| T-43 | Startbild | Idee: das Bild auch als **Hintergrund in der App**, in den Einstellungen wählbar. **Abgeraten** — starke lokale Kontraste machen Text schwer lesbar, die festen Farben beissen sich mit „Tinte" und „Graphit", und die Komposition würde hinter einer rollenden Liste zerschnitten. Vorschlag stattdessen: das Bild dort zeigen, wo kein Text darauf liegt — im Über-Bildschirm (umgesetzt) und im leeren Zustand einer neuen Liste (offen). |
...
| T-43 · zurückgenommen | Das Bild in den leeren Zuständen sieht seltsam aus und ist wieder draussen. Es bleibt beim Startbildschirm und bei „Über SmartVoc" — dort, wo es die ganze Breite hat. Ein beschnittener Ausschnitt mitten auf einer sonst leeren Seite trägt nicht. |
| T-48 | Üben · Übung verlassen | **„Übung verlassen" tut sichtbar nichts** — vermutlich setzt es die Liste nur auf den Anfang zurück. Ein Abbruch braucht eine deutlichere Reaktion. Vorschläge: (1) Es **„Übung beenden"** nennen. (2) Als Reaktion — **und beim App-Start** — lösen sich alle Auswahlen oben, und statt Kartenstapel, Fortschrittsbalken und Bedienelementen steht dort *„Wähle eine Wortliste (über die Auswahlknöpfe oben)"*. Gibt es überhaupt keine Liste: *„Keine Wortlisten gespeichert. Erfasse deine erste Wortliste"* mit Link auf das Anlegen. |
| T-49 | Wortlisten · Zieldatum | Der Papierkorb neben dem Datum **sagt nicht, worauf er sich bezieht**. Die Möglichkeit, das Zieldatum zu löschen, gehört **direkt in den Datums-Dialog**. |
| T-50 | Wortlisten | **Metadaten** in die Wortlisten einbauen: Autor, erstellt am, zuletzt geändert. |
| T-51 | app-weit · Texte | **Alle Texte überarbeiten**: keine KI-Floskeln, keine offensichtlich maschinellen Wendungen, keine Gedankenstriche. Danach ein **Word-Dokument mit sämtlichen deutschen Texten** zur finalen Überarbeitung. |
| T-51 · Teil 1 umgesetzt | 91 Oberflächentexte und die Hilfe von Gedankenstrichen befreit, jeder einzeln umformuliert statt ersetzt: mal ein Punkt, mal ein Komma, mal ein Doppelpunkt, je nachdem, was die beiden Hälften miteinander zu tun haben. Nebenbei zwei Fundstücke berichtigt: „es gibt noch kein FSRS-Objekt (state New)“ und „Klicke den Stift“ auf einem Gerät ohne Maus. Die **englische Fassung** ist noch offen; sie steht ohnehin für deine Korrektur an. |
| V2 | Wortlisten · Export | Wortlisten in **mehrere Formate exportieren**, nicht nur Excel — zum Beispiel PDF. Vorgemerkt in `KONZEPT-STUFEN.md`. |
| T-48 · umgesetzt | Heisst jetzt **„Übung abbrechen"** und tut sichtbar etwas: die Auswahl wird geleert, die Bühne bleibt leer, und es steht da, was zu tun ist. Derselbe Zustand erscheint, wenn du oben von Hand alles abwählst. Gibt es überhaupt keine Liste, steht dort *„Noch keine Wortliste gespeichert"* mit einem Knopf, der zu den Wortlisten führt. Die Pille oben zeigt dann **„Wortliste wählen"** ohne Zahl statt „Übung 30". Dafür war ein eigener Zustand nötig: vorher fiel die App bei leerer Auswahl still auf „Heute dran" zurück, weshalb der Knopf nichts zu tun schien. |
| T-52 | Einstellungen · Üben | Neu: **„Wortliste beim Öffnen"** mit vier Möglichkeiten — *Heute dran* (Voreinstellung), *Zuletzt geübte Liste, weitermachen*, *Zuletzt geübte Liste, neu beginnen*, *Nichts vorwählen*. Für „weitermachen" merkt sich die App die beim letzten Mal **offen gebliebenen Wörter** (nur deren Kennungen) und beginnt mit denen. Den eingefrorenen FSRS-Zustand über einen Neustart zu schleppen wäre die Art Abkürzung, die Lerndaten beschädigt. |
| T-53 | Üben · Auswahl | **Smart Lists lassen sich nicht abwählen.** Eigene Listen schalten beim Antippen um, Smart Lists wurden nur gesetzt — man wurde sie nur los, indem man zuerst eine eigene Liste wählte. |
